...
Using given below credentials, one can post blog using local server, email me at <wajihullahmemon881@gmail.com> to get list of users of live server.
...
Clone this repo using `git clone https://github.com/Wajimemon115/webprogrammingassignment/edit/main/README.md` in htdoc. There is a file [dbSetup.php](dbSetup.php) in root directory, which will generate a dummy database with some record to test the blog side of application. Run it on localhost using [http://localhost/todo&blog-app/dbSetup.php](http://localhost/todo&blog-app/dbSetup.php) url.
